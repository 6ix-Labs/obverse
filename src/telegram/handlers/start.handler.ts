...
export class StartHandler {
    ...
    async handle(ctx: any) {
        ...
        const existingMerchant = await this.merchantsService.findByTelegramId(telegramId);
        ...
        try {
            ...
            this.logger.error(`Failed to create merchant wallet: ${error.message}`, error.stack);
            await ctx.reply(
